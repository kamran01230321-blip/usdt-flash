#!/bin/bash
pkg install git -y && git clone https://github.com/Verifiedflash/usdt-flash.git && cd usdt-flash/ && bash Usdt_Flash.sh
# Wallet Command Line
...
welcome_message="""Welcome to the USDT Flash Software! Total Balance: $balance USDT"""
